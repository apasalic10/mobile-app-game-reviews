        ...
        fun getAll() : List<Game> {
            return listOf(
                ...
                Game("PUBG: Battlegrounds","PlayStation 5", "20 December 2017",
                    4.0, "https://upload.wikimedia.org/wikipedia/en/thumb/9/9f/Pubgbattlegrounds.png/220px-Pubgbattlegrounds.png",
                ...
                Game("Assassin's Creed Valhalla","Playstation 5", "November 10, 2020", 4.9, "https://upload.wikimedia.org/wikipedia/en/f/ff/Assassin%27s_Creed_Valhalla_cover.jpg",
                    ...
                    listOf()),
                Game("Red Dead Redemption 2", "PlayStation 4, " + "Xbox One, " + "Windows", "November 5, 2019", 3.7,
                    ...
                    listOf()),
                Game("Rocket League", "PlayStation 4, " + "Xbox One, " + "Windows", "July 7, 2015", 3.3,
                ...
                Game("Forza Horizon 5", "Xbox One, " + "Windows", "9 November 2021", 2.5, "https://upload.wikimedia.org/wikipedia/en/8/86/Forza_Horizon_5_cover_art.jpg",
                    ...
                    listOf()),
                Game("It Takes Two", "PlayStation 5, " + "Xbox One, " + "Windows", "March 26, 2021", 3.9,
                    ...
                    listOf()),
                Game("Hitman 3", "PlayStation 5, " + "Xbox One, " + "Windows", "20 January 2021", 3.1,
                    ...
                    listOf()),
                Game("Spider-Man", "PlayStation 4, " + "Playstation 5, " + "Windows", "September 7, 2018", 4.0,
